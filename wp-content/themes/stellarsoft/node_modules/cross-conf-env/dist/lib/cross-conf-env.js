...
exports.replaceArgv = replaceArgv;
/**
 * Replace the value of the command line arguments in process.env, and run the process with a replaced arguments.
 * @param argv Arguments of the command line.
 * @returns Process.
 */
const crossConfEnv = (argv) => {
    const newArgv = (0, exports.replaceArgv)(argv, (0, exports.filterKeys)());
...
exports.crossConfEnv = crossConfEnv;
