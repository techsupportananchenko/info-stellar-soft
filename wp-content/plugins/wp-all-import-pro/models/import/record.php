                        ...
                        if (ctype_digit($comment_post[$i])) {
                            ...
                            if ( $comment_post_found === false ) {
                                ...
                                if ( $comment_parent_record && ! is_wp_error( $comment_parent_record ) ) {
                                    // Do not allow import comments for products
                                    if ($this->options['custom_type'] == 'comments' && $comment_parent_record[0] && $comment_parent_record[0]->post_type === 'product') {
                                        $comment_post_found = false;
                                    } else {
					...
					if ( $this->options['update_all_data'] == 'no' ){
                        ...
                        switch ($this->options['custom_type']){
	                        ...
	                        case 'gf_entries':
	                        	...
	                        	break;
                            default:
                                $this->importer->choose_data_to_update($post_to_update, $post_to_update_id, $post_type[$i], $taxonomies, $articleData, $i);
                                break;
                        }
					} else {
